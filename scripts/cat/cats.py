    ...
    def __init__(
        ...
        **kwargs
        ...
        def GenerateWhite(KIT, albino, KITgrade, vit, white_pattern, pax3):
            ...
            if (white_pattern is None and KIT[0] != 'wsal') or ((white_pattern == "No" or (white_pattern is not None and len(white_pattern) == len(has_vitiligo) and len(has_vitiligo) > 0)) and (KIT[0] == 'wg' or 'NoDBE' not in pax3 or KIT[1] in ["ws", "wt"])):
                white_pattern = []
                if 'wt' in KIT:
