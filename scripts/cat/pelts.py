...
class Pelt:
    ...
    exotic = ["Bengal", "Sterbengal", "Sillybengal", "Dancebengal", "Mimibengal", 
              ...
              "Masked", "Stermasked", "Sillymasked", "Dancemasked", "Mimimasked", "Maned", "Ocelot", "Cheetah", "Wildcat", "Wolf", "Finleappatches", "Dalmatian", "Abyssinian", "Clouded", "Snowflake", "Oceloid", "Monarch", "Stain"]
    ...
    little_white = ['LITTLE', 'LIGHTTUXEDO', 'BUZZARDFANG', 'TIP', 'BLAZE', 'BIB', 'VEE', 'PAWS',
                    ...
                    'MASK', 'PAW', 'BOOMSTAR', 'LEGS', 'DOVE', 'CRESCENT', 'SPIDERLEGS', 'APPEL', 'BLACKLITTLE', 'BLACKLIGHTTUXEDO', 'BLACKBUZZARDFANG', 'BLACKTIP', 'BLACKBLAZE', 'BLACKBIB', 'BLACKVEE',
    ...
    mid_white = ['TUXEDO', 'FANCY', 'UNDERS', 'DAMIEN', 'SKUNK', 'MITAINE', 'SQUEAKS', 'STAR', 'WINGS',
                ...
                'MINKBLANKET', 'MINKBELOVED', 'MINKHEARTBEAT', 'MINKCHIMERA', 'MINKEYEDOT', 'MINKSHILOH', 'INK', 'GEM', 'FOX','ORCA', 'MOJO', 'HALFHEART', 'LEON', 'MEADOW', 'BAMBI', 'SKUNKSTRIPE', 'BANAN',
                 'MOONSTONE', 'WINGTWO', 'STARBORN', 'RUG', 'BLACKTUXEDO', 'BLACKFANCY', 'BLACKUNDERS', 'BLACKDAMIEN', 'BLACKSKUNK', 'BLACKMITAINE', 'BLACKSQUEAKS',
    ...
    high_white = ['ANY', 'ANYTWO', 'BROKEN', 'FRECKLES', 'RINGTAIL', 'HALFFACE', 'PANTSTWO',
                ...
                'MINKTHREE', 'MINKOREO', 'WOLF', 'PINTO', 'CHESSBORAD', 'SUNRISE','HUSKY', 'S', 'STATNTHREE', 'MIST', 'LADY', 'HALF', 'SUN',
                  'PINTOTWO', 'SKY', 'MINKGRUMPYFACE', 'MINKPACMAN', 'MINKPAIGE', 'MINKMOTTLED', 'MINKDELILAH', 'BLACKANY', 'BLACKANYTWO', 'BLACKBROKEN', 'BLACKFRECKLES', 'BLACKRINGTAIL', 'BLACKHALFFACE',
    ...
    mostly_white = ['VAN', 'ONEEAR', 'LIGHTSONG', 'TAIL', 'HEART', 'MOORISH', 'APRON', 'CAPSADDLE',
                    ...
                    'MOSCOW', 'PANDA', 'LUCKY', 'EYESPOT', 'PEBBLE', 'TAILTWO', 'BUDDY', 'KROPKA', 'MINKHALF', 'MINKBANDANA','MINKSWOOP', 'BLACKVAN', 'BLACKONEEAR', 'BLACKLIGHTSONG', 'BLACKTAIL', 'BLACKHEART', 'BLACKMOORISH', 'BLACKAPRON',
    ...
    point_markings = ['COLOURPOINT', 'ANT', 'CAPETOWN',
                      'SNOWSHOE', 'ETERNAL', 'RAGDOLL', 'SEPIAPOINT', 'MINKPOINT', 'SEALPOINT', 'MINKSMOKE', 'MINKBODY', 'BLACKCOLOURPOINT', 'BLACKRAGDOLL', 'BLACKSEPIAPOINT', 'BLACKMINKPOINT', 'BLACKSEALPOINT',
    ...
    vit = ['VITILIGO', 'VITILIGOTWO', 'MOON', 'PHANTOM', 'KARPATI', 'POWDER', 'BLEACHED', 'SMOKEY', 'MINKBRINDLE', 'MINKFRECKLED', 'MINKSMUDGED','JACKAL', 'EYEV', 'FRECKLESTWO', 'CREAMV', 'SALT', 'NEPTUNE', 'BLACKVITILIGO', 'BLACKVITILIGOTWO', 'BLACKMOON', 'BLACKPHANTOM', 'BLACKKARPATI', 'BLACKPOWDER', 'BLACKBLEACHED',
