...
def get_random_moon_cat(Cat, main_cat, parent_child_modifier=True, mentor_app_modifier=True):
    ...
    if possible_r_c:
        ...
        if mentor_app_modifier:
            if main_cat.status in ["apprentice", "mediator apprentice", "healer apprentice"] \
                    and main_cat.mentor \
    ...
    def draw_sprite(genotype, phenotype, cat_sprite, somatic = False):
        ...
        def GenSprite(genotype, phenotype):
            ...
            def TabbyBase(whichcolour, whichbase, special = None):
                ...
                if special !='copper' and cat.moons > 12 and 'infertility' not in cat.permanent_condition and (genotype.silver[0] == 'I' and genotype.sunshine[0] == 'fg' and (get_current_season() == 'Leaf-fall' or get_current_season() == 'Leaf-bare')):
