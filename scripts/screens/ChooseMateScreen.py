...
class ChooseMateScreen(Screens):
    ...
    def update_selected_cat(self):
        ...
        if not game.clan.clan_settings["same sex birth"] and not (xor('Y' in self.the_cat.genotype.sexgene, 'Y' in self.selected_cat.genotype.sexgene) 
            and 'infertility' not in self.the_cat.permanent_condition and 'infertility' not in self.selected_cat.permanent_condition 
            and ('Y' not in self.the_cat.genotype.sexgene or self.the_cat.genotype.gender != 'molly')):
